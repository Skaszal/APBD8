...
namespace Exercise6
{
    public static class LinqTasks
    {
        ...
        {
            IEnumerable<object> result = 
                    from e in Emps join dept in Depts on e.Deptno equals dept.Deptno 
                    select new {e.Ename, e.Job, dept.Dname};
            return result;
        }
    ...
    public static class CustomExtensionMethods
    {
        public static IEnumerable<Emp> WithSubordinates(this IEnumerable<Emp> employees)
        {
            ...
            return employeesList
                .Where(e => employeesList.Any(sub => sub.Mgr.Empno == e.Empno))
                .OrderBy(e => e.Ename)
